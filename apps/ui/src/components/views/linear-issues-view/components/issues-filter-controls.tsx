...
import type { LinearIssuesStateFilter } from '../types';
import { LINEAR_STATE_FILTER_OPTIONS } from '../types';
...
interface IssuesFilterControlsProps {
  ...
  onStateFilterChange: (filter: LinearIssuesStateFilter) => void;
...
const STATE_FILTER_LABELS: Record<LinearIssuesStateFilter, string> = {
  open: 'Open',
  closed: 'Closed',
  all: 'All',
};
  ...
  return (
    <div className={cn('flex flex-col gap-2', className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <Select
          value={stateFilter}
          onValueChange={(value) => onStateFilterChange(value as LinearIssuesStateFilter)}
          disabled={disabled}
        >
          ...
          <SelectContent>
            {LINEAR_STATE_FILTER_OPTIONS.map((option) => (
